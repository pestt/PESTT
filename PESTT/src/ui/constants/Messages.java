...
public class Messages {
	...
	public static final String TEST_PATH_SUCCESS_EDITED_MSG = "Test path successfully edited.";
	...
	public static final String TEST_REQUIREMENT_SUCCESS_EDITED_MSG = "Test requirement successfully edited.";
