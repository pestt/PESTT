...
public class DefUsesViewerFactory implements Observer {
	...
	public DefUsesViewerFactory() {
		...
		State state = cmdService.getCommand(Description.DEF_USES_VIEWER_BUTTON).getState("org.eclipse.ui.commands.radioState");
	...
	public TableViewer createTebleViewer(Composite parent, IWorkbenchPartSite site) {
		this.parent = parent;
		this.site = site;
		switch(view) {
			case NODE_EDGE:
