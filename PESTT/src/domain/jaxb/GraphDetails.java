...
public class GraphDetails {
	...
	private void setGraphInitialNodes() {
		for(Node<Integer> node : Activator.getDefault().getSourceGraphController().getSourceGraph().getInitialNodes())
	...
	private void setGraphFinalNodes() {
		for(Node<Integer> node : Activator.getDefault().getSourceGraphController().getSourceGraph().getFinalNodes())
	...
	private void setGraphNodes() {
		for(Node<Integer> node : Activator.getDefault().getSourceGraphController().getSourceGraph().getNodes())
	...
	private void setGraphEdges() {
		for(Node<Integer> node : Activator.getDefault().getSourceGraphController().getSourceGraph().getNodes())
			for(Edge<Integer> edge : Activator.getDefault().getSourceGraphController().getSourceGraph().getNodeEdges(node))
