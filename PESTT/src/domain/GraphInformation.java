...
public class GraphInformation {
	...
	/**
	 * Associates the node in the abstract graph representation and the
	 * correspondent one in the layout graph. * This information is stored in
	 * abstract graph meta-data Layer.EMPTY.
	 * 
	 * @param sourceGraph
	 *            - The abstract representation of the graph.
	 * @param sourceNode
	 *            - The abstract representation of the node in the abstract
	 *            graph.
	 * @param layoutNode
	...
	/**
	 * Associates the program instructions to the corresponding node in the
	 * abstract grapg. This information is stored in abstract graph meta-data
	 * Layer.INSTRUCTIONS.
	 * 
	 * @param sourceGraph
	 *            - The abstract representation of the graph.
	 ...
	 *            graph.
	 * @param instructions
	 *            - The program instructions associated to the sourceNode.
	 * @param unit
	...
	/**
	 * Add guards information to abstract graph edge. This information is stored
	 * in abstract graph meta-data Layer.GUARDS.
	 * 
	 * @param sourceGraph
	 *            - The abstract representation of the graph.
	 * @param sourceEdge
	 *            - The abstract representation of the edge in the abstract
	 *            graph.
	 * @param info
