...
public class Messages {
	...
	public static final String SELECT_COVERAGE = "You need to select a coverage criteria in the Graph Coverage Criteria view.";
	public static final String SELECT_VALID_COVERAGE = "You need to select a valid coverage criteria in the Graph Coverage Criteria view.";
	public static final String NEED_UPDATE = "You need to update the test requirements.";
	public static final String NEED_TO_DRAW = "You need to draw the graph first.";
	public static final String GRAPH_INPUT_TITLE = "PESTT - Test path input";
	public static final String GRAPH_INPUT_MSG = "You need to enter a test path.";
	public static final String GRAPH_INVALID_INPUT_MSG = "You need to enter a valid test path.";
	public static final String GRAPH_REMOVE_MSG = "Test path successfully removed.";
	public static final String GRAPH_SELECT_TO_REMOVE_MSG = "You need to select a test path to be removed.";
	public static final String GRAPH_SELECT_TOTTAL_TO_REMOVE_MSG = "You can't remove the Total. Please select a valid test path to remove.";
