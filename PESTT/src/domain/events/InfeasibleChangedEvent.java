...
public class InfeasibleChangedEvent {
	...
	public InfeasibleChangedEvent(Iterable<AbstractPath<Integer>> testRequirementSet, Iterable<AbstractPath<Integer>> infeasigles, Iterable<Path<Integer>> manuallyAdded, boolean hasInfinitePath) {
